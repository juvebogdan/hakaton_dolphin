...
class DolphinClassifier:
    ...
    def plot_feature_importance(self, top_n=20):
        ...
        if hasattr(self.clf, 'feature_importances_'):
            ...
            plt.xticks(range(top_n), [self.feature_names[i] for i in indices[:top_n]], rotation=90)
            plt.xlim([-1, top_n])
            plt.tight_layout()
            ...
            print(f"Feature importance plot saved to {os.path.join(output_dir, 'feature_importance_permutation.png')}")
...
def main():
    ...
    # Create a new classifier instance for loading
